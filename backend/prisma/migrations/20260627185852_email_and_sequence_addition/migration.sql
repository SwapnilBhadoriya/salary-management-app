...
INSERT INTO "new_Employee" ("countryId", "createdAt", "departmentId", "employeeId", "id", "name", "roleId", "updatedAt") SELECT "countryId", "createdAt", "departmentId", "employeeId", "id", "name", "roleId", "updatedAt" FROM "Employee";
DROP TABLE "Employee";
